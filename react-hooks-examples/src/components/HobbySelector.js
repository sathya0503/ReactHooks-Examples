                                    ...
                                    <div className="col-md-3">
                                        <form>
                                            <div className="form-check">
                                                <input name="eating" onChange={updateCheck} className="form-check-input" type="checkbox" value={''} id='defaultCheck1'/>
                                                <label className="form-check-label" htmlFor="defaultCheck1">Eating</label>
                                            </div>
                                            <div className="form-check">
                                                <input name="coding" onChange={updateCheck} className="form-check-input" type="checkbox" value={''} id='defaultCheck2'/>
                                                <label className="form-check-label" htmlFor="defaultCheck2">Coding</label>
                                            </div>
                                            <div className="form-check">
                                                <input name="sleeping" onChange={updateCheck} className="form-check-input" type="checkbox" value={''} id='defaultCheck3'/>
